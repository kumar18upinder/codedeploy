...
const TaxController_1 = __importDefault(require("./TaxController"));
...
exports.default = router
    ...
    return TaxController_1.default.list(req.query)
    ...
    return TaxController_1.default.detail(Object.assign(Object.assign({}, req.query), req.params))
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
    .post("/", [validator.body(VALIDATE.add)], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return TaxController_1.default.add(req.body)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
