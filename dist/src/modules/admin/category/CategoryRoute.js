...
exports.default = router
    ...
    return CategoryController_1.default.list(req.query, req.auth)
    ...
    return CategoryController_1.default.detail(Object.assign(Object.assign({}, req.query), req.params), req.auth)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
    .post("/", [validator.body(VALIDATE.add)], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return CategoryController_1.default.add(req.body, req.auth)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
    ...
    return CategoryController_1.default.update(Object.assign(Object.assign({}, req.params), req.body), req.auth)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
    .patch("/status/:id", [validator.params(VALIDATE.updateParam)], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return CategoryController_1.default.updateStatus(Object.assign(Object.assign({}, req.params), req.body), req.auth)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}))
    .delete("/:id", [validator.params(VALIDATE.remove)], (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    return CategoryController_1.default.remove(req.params, req.auth)
        .then(response => ResponseHandler_1.default.sendResponse(res, response))
        .catch(error => ResponseHandler_1.default.sendErrorResponse(res, error));
}));
